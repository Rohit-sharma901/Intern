...
username = quote_plus("sharma109rohit")
password = quote_plus("21612934-Rs")
uri = f'mongodb+srv://{username}:{password}@cluster0.dkfxw.mongodb.net/Intern?retryWrites=true&w=majority&appName=Cluster0'
